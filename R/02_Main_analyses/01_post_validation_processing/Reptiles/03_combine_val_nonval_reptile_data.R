...
folder_path_all <- paste0(data_storage_path,"Biodiversity_combined/Expert_validation/Checklists/Reptiles/All_Lists")
...
validated_basenames <- sapply(reptiles_dfs, function(x) x)
