...
folder_path_all <- paste0(data_storage_path,"Biodiversity_combined/Expert_validation/Checklists/Birds/All_Lists")
...
validated_basenames <- sapply(birds_dfs, function(x) x)
