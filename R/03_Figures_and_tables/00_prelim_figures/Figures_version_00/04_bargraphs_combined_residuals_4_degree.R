...
# 
pdf("~/Desktop/Datasets/output_shared/Vertebrates/bar_plots/no_lim.pdf",width=14,height=8)
...
for (mountain_range in unique(species_richness_modified$Mountain_range)) {
  ...
  filename <- paste0("~/Desktop/Datasets/output_shared/Vertebrates/bar_plots/svgs/residuals_", safe_filename, ".svg")
