...
birds_res <- proportional_richness_results %>%
...
# 
pdf("~/Desktop/Datasets/Biodiversity_combined/Visuals/Visuals_Manuscript/Basemaps/Chloropleth/birds.pdf", width = 11, height = 6)
