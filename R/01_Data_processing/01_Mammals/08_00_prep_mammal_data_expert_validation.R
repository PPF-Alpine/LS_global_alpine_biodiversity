...
Data_mammals <- readxl::read_excel(paste0(data_storage_path,"/subm_global_alpine_biodiversity/Data/Mammals/processed/DEM/Checklist_Mammals_elevations_DEM_all_mountains.rds"))|>
